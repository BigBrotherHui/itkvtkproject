...
#ifndef vtkResliceImageViewer2_h
#define vtkResliceImageViewer2_h
...
class vtkResliceImageViewer2 : public vtkImageViewer2 {
public:
    ///@{
    /**
     * Standard VTK methods.
     */
    static vtkResliceImageViewer2* New();
    vtkTypeMacro(vtkResliceImageViewer2, vtkImageViewer2);
    ...
    virtual void SetResliceModeToAxisAligned() { this->SetResliceMode(vtkResliceImageViewer2::RESLICE_AXIS_ALIGNED); }
    virtual void SetResliceModeToOblique() { this->SetResliceMode(vtkResliceImageViewer2::RESLICE_OBLIQUE); }
...
protected:
    vtkResliceImageViewer2();
    ~vtkResliceImageViewer2() override;
...
private:
    vtkResliceImageViewer2(const vtkResliceImageViewer2&) = delete;
    void operator=(const vtkResliceImageViewer2&) = delete;
};
