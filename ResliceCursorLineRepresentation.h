...
class ResliceCursorLineRepresentation : public vtkResliceCursorLineRepresentation
{
public:
  /**
   * Instantiate the class.
   */
  static ResliceCursorLineRepresentation* New();

  ///@{
  /**
   * Standard VTK methods.
   */
  vtkTypeMacro(ResliceCursorLineRepresentation, vtkResliceCursorLineRepresentation);
...
protected:
  ...
  ~ResliceCursorLineRepresentation() override;
...
private:
    ResliceCursorLineRepresentation(const ResliceCursorLineRepresentation&) = delete;
  void operator=(const ResliceCursorLineRepresentation&) = delete;
};
